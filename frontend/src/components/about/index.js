		...
		<div class="col s8 offset-s2">
			<div class="card blue-grey darken-1 white-text">
				<div class="card-content">
					...
					<br></br>
					<p>Socket Poker is open source software, on github here: <a href="https://github.com/philwade/socket-poker">https://github.com/philwade/socket-poker</a></p>
					<h3>About Pointing Poker</h3>
					<p>Pointing poker is a way for agile teams to size tickets for inclusion in sprints. For more: <a href="https://en.wikipedia.org/wiki/Planning_poker">https://en.wikipedia.org/wiki/Planning_poker</a></p>
				</div>
			</div>
		</div>
	</div>
